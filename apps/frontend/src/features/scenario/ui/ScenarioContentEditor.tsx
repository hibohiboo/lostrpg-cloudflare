import { Box, InputLabel, Link as MuiLink, Tab, Tabs, TextField } from '@mui/material';
...
export const ScenarioContentEditor: React.FC<Props> = ({ content, onContentChange }) => {
  ...
  return (
    <Box>
      ...
      {tab === 1 && <StructuredEditor content={content} onContentChange={onContentChange} />}
    </Box>
  );
};
