...
export interface ScenarioListPageState {
  searchInput: string;
...
const initialState: ScenarioListPageState = {
  searchInput: '',
  appliedSearchName: '',
  offset: 0,
};

export const scenarioListPageSlice = createSlice({
...
export const { setSearchInput, submitSearch, setOffset, resetListPage } =
  scenarioListPageSlice.actions;

export default scenarioListPageSlice.reducer;
