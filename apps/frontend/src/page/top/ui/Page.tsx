  ...
  <div className="min-h-screen relative flex flex-col items-center justify-center text-white overflow-hidden font-sans">
    ...
    <div className="relative z-10 container mx-auto px-4 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-6 max-w-5xl mx-auto">
        ...
        <Link
          to="/enemy"
          className="group block p-8 rounded-2xl bg-black/30 backdrop-blur-md border border-white/10 hover:bg-black/40 hover:border-lime-400/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-lime-900/20 hover:shadow-2xl"
        >
          <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-300">
            👾
          </div>
          <h2 className="text-2xl font-bold mb-3 text-lime-300 group-hover:text-lime-200">
            エネミー
          </h2>
          <p className="text-sm text-gray-300 leading-relaxed">
            冒険者たちの前に立ちはだかる者
        ...
        <Link
          to="/scenario"
          className="group block p-8 rounded-2xl bg-black/30 backdrop-blur-md border border-white/10 hover:bg-black/40 hover:border-violet-400/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-violet-900/20 hover:shadow-2xl"
        >
          <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-300">
            📖
          </div>
