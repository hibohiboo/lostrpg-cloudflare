          ...
          <nav className="mt-4 sm:mt-0">
            <ul className="flex space-x-1 sm:space-x-4 overflow-x-auto w-full justify-center sm:justify-end pb-2 sm:pb-0">
              ...
              <li>
                <Link
                  to="/boss"
                  className="flex items-center space-x-2 px-3 py-2 rounded-lg hover:bg-slate-800 hover:text-rose-400 transition-all duration-300 group"
                >
                  <span className="text-xl group-hover:scale-110 transition-transform">
                    🐉
                  </span>
                  <span className="hidden sm:inline font-medium">ヌシ</span>
                </Link>
              </li>
              <li>
                <Link
