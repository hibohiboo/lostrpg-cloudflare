...
export const abilityList = [
  {
    ...
    list: [
      ...
      },
      {
        ...
        target: '-',
        effect:
          '命中判定に組み合わせて使用する。ダメージを使用した武器の[重量]増加させる。',
      },
      {
        name: '集中',
        group: '汎用',
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        target: '自身',
        effect:
          'キャラメイク時の初期Jにプラス5Jする。また、セッション開始時に3J獲得できる。',
      },
      {
        name: '旧友',
        group: 'オトナ',
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        target: '単体',
        effect:
          'ダメージ適用の直前に使用する。指定特技の判定に成功するとダメージを1点軽減できる。追加で気力を1点消費し、指定特技の判定に成功すると、さらに1点のダメージを軽減できる。これは判定に失敗するまで続けてよい。',
      },
      {
        name: '治癒',
        group: 'ニューエイジ',
      ...
      },
      {
        ...
        target: '自身',
        effect:
          'ムシ、ケモノ、ミュータントのグループアビリティからランダムに１つアビリティを習得できる。ただし、その反動が1増加する。常駐タイプのアビリティを習得した場合、【精神力】が2点減少する。毎セッションの終了時に突然変異表を振りなおしてもよい。',
      },
      {
        name: '瞬間移動',
        group: 'ニューエイジ',
...
export const trophyAbilityList = [
  {
    ...
    list: [
      ...
      },
      {
        ...
        target: '自身',
        effect:
          '他者のアビリティまたは他者が使用したアイテムの効果で気力を獲得する場合、追加で1点獲得する',
      },
      {
        name: 'まだまだっ',
        group: 'パッション',
